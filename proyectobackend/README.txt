...
a persistence unit "proyectobackendPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proyectobackend/pom.xml":
...
artifact ("proyectobackend.war") is already built. You can build
